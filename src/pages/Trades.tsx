              ...
              {sortedTrades.map((trade, index) => (
                ...
                >
                  ...
                  <TableCell className="text-muted-foreground text-sm">
                    {format(new Date(trade.openDate), 'MMM dd, yyyy HH:mm')}
                  </TableCell>
                  <TableCell className="text-muted-foreground text-sm">
                    {format(new Date(trade.closeDate), 'MMM dd, yyyy HH:mm')}
                  </TableCell>
                  <TableCell className="font-mono">{trade.quantity}</TableCell>
                  <TableCell className={cn(
                    "font-mono font-semibold",
                    trade.grossPnl >= 0 ? "profit-text" : "loss-text"
                  )}>
                  ...
                  <TableCell className="font-mono">{trade.rewardRatio.toFixed(2)}</TableCell>
                  <TableCell>
